...
import { deleteDocumentSource, getDocumentSource } from "../../../api/document_source"
...
const DocumentSource = () => {
    ...
    const handleDelete = (key) => {
        deleteDocumentSource(key)
            ...
            .catch((error) => {
                MySwal.fire({
                    title: "Xóa nguồn tài liệu thất bại",
                    icon: "error",
                    customClass: {
    ...
    return (
        <Card
            title="Danh sách nguồn tài liệu"
