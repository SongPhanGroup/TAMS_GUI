...
import { deleteOrganization, getOrganization } from '../../../api/organization'
import AddNewOrganization from './modal/AddNewModal'
import EditOrganization from './modal/EditModal'
...
const Organization = () => {
    ...
    const handleDeleteOrganization = (data) => {
        return Swal.fire({
            title: '',
            ...
            if (result.value) {
                deleteOrganization(data).then(result => {
                ...
                return (
                    <div className="column-action d-flex align-items-center">
                        ...
                        {ability.can('delete', 'nguoidung') &&
                            <div id="tooltip_trash" style={{ marginRight: '1rem', marginLeft: '1rem' }} onClick={() => handleDeleteOrganization(row.id)}>
                                <Trash
                                    size={15}
    ...
    return (
        <Fragment>
            ...
            <AddNewOrganization open={modalAddNew} handleAddModal={handleAddModal} getData={fetchOrganization} />
            {dataEdit && <EditOrganization open={modalEdit} handleEditModal={handleEditModal} getData={fetchOrganization} dataEdit={dataEdit} />}
        </Fragment >
    )
}
