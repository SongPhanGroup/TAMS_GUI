...
import { deletePermission, getPermission } from '../../../api/permission'
import AddNewPermission from './modal/AddNewModal'
import EditPermission from './modal/EditModal'
...
const Permission = () => {
    ...
    const handleDeletePermission = (data) => {
        return Swal.fire({
            ...
            if (result.value) {
                deletePermission(data).then(result => {
                ...
                return (
                    <div className="column-action d-flex align-items-center">
                        ...
                        {ability.can('delete', 'nguoidung') &&
                            <div id="tooltip_trash" style={{ marginRight: '1rem', marginLeft: '1rem' }} onClick={() => handleDeletePermission(row.id)}>
                                <Trash
                                    size={15}
        ...
        <Fragment>
            <Card style={{ backgroundColor: 'white' }}>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    <CardTitle tag='h4'>Danh sách quyền</CardTitle>
            ...
            <AddNewPermission open={modalAddNew} handleAddModal={handleAddModal} getData={fetchPermission} />
            {dataEdit && <EditPermission open={modalEdit} handleEditModal={handleEditModal} getData={fetchPermission} dataEdit={dataEdit} />}
        </Fragment >
    )
}
