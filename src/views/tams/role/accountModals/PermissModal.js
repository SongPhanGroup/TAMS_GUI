...
import { updateUserManyRole } from "../../../../api/user_role"
  ...
  return (
    ...
    >
      <ModalHeader
        ...
        close={CloseBtn}
        tag="div"
        style={{ color: '#036CBF', borderBottom: '1px solid', backgroundColor: '#fff' }}
      >
        <h4 className="modal-title" style={{ color: '#036CBF' }}
